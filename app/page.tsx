...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Composition analysis, resolution check, artifact detection using Gemini Vision and advanced image processing.",
      icon: "📸",
    },
    {
      ...
      <section className="h-screen w-full rounded-md flex md:items-center md:justify-center bg-black/[0.96] antialiased bg-grid-white/[0.02] relative overflow-hidden">
        ...
        <div className="p-4 max-w-5xl mx-auto relative z-10 w-full pt-20 md:pt-0">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a href="https://github.com/GonzaMato/adcompass" target="_blank" rel="noopener noreferrer">
            ...
            <ScrollReveal animation="scale" delay={200}>
              <Card hover className="group cursor-pointer transform transition-all duration-300 hover:scale-110 bg-neutral-900 border-neutral-800">
                <div className="text-center">
                  ...
                  <h3 className="font-bold text-white group-hover:text-blue-400 transition-colors">n8n</h3>
                  <p className="text-sm text-neutral-400 mt-1">Workflow Automation</p>
                </div>
              </Card>
            </ScrollReveal>
            ...
            <ScrollReveal animation="scale" delay={300}>
              <Card hover className="group cursor-pointer transform transition-all duration-300 hover:scale-110 bg-neutral-900 border-neutral-800">
                <div className="text-center">
                  ...
                  <h3 className="font-bold text-white group-hover:text-yellow-400 transition-colors">Next.js 16</h3>
            ...
            <ScrollReveal animation="scale" delay={400}>
              <Card hover className="group cursor-pointer transform transition-all duration-300 hover:scale-110 bg-neutral-900 border-neutral-800">
                <div className="text-center">
                  ...
                  <h3 className="font-bold text-white group-hover:text-pink-400 transition-colors">Prisma</h3>
                  <p className="text-sm text-neutral-400 mt-1">Type-safe ORM</p>
                </div>
              </Card>
            </ScrollReveal>
          </div>
          ...
          <ScrollReveal animation="fade" delay={600}>
            <div className="mt-12 text-center">
              <p className="text-neutral-400">
                Built with <span className="font-semibold text-purple-400">TypeScript</span>, <span className="font-semibold text-blue-400">Tailwind CSS</span>, and deployed on <span className="font-semibold text-orange-400">Google Cloud Platform</span>
              </p>
            </div>
          </ScrollReveal>
        </div>
